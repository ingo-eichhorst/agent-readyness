...
- Test covers: healthy metrics -> high score, poor metrics -> low score, missing coverage handling, empty coupling maps, zero-division guards, full Score() round-trip
</verification>
