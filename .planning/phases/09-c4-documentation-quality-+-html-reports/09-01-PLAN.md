...
go build ./... compiles without errors
  ...
  <done>
C4Analyzer exists with all static metric functions implemented. C4Metrics struct defined in types.
  </done>
</task>
...
6. Add case "C4": renderC4(w, ar, verbose) to RenderSummary switch
...
<task type="auto">
  <name>Task 3: Add unit tests and wire into pipeline</name>
  <files>
    internal/analyzer/c4_documentation_test.go
    internal/pipeline/pipeline.go
  </files>
  <action>
1. Create internal/analyzer/c4_documentation_test.go:
