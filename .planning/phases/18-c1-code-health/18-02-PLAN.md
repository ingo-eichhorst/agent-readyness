...
<task type="auto">
  ...
  <action>
Update the 6 C1 metric descriptions in `descriptions.go` to add/enhance inline citations. Use `<span class="citation">(Author, Year)</span>` format. Reference the verified sources from 18-RESEARCH.md.
