...
// Format: M1: Running (2/5) | M2: Complete (8) | M3: Pending | Tokens: 12,345 | Est. $0.15
func (p *C7Progress) render() {
    ...
    for _, id := range p.metricOrder {
        ...
        case StatusRunning:
            parts = append(parts, fmt.Sprintf("%s: %d/%d", shortID, m.CurrentSample, m.TotalSamples))
        case StatusComplete:
    ...
    fmt.Fprintf(p.writer, "%-120s", line)
}
