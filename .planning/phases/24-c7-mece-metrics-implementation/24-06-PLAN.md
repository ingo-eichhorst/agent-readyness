...
@.planning/phases/24-c7-mece-metrics-implementation/24-05-SUMMARY.md
    ...
    targets := []*types.AnalysisTarget{
        {
            ...
            Files: []*types.SourceFile{
                {Path: "/test/main.go", LOC: 100, Class: types.ClassSource},
                {Path: "/test/util.go", LOC: 50, Class: types.ClassSource},
            },
        },
    }
