...
// Thresholds for auto-expanding metric details in HTML reports.
// Metrics scoring below their threshold are expanded to draw attention.
const (
	defaultExpandThreshold = 6.0
	lenientExpandThreshold = 5.0
...
var metricDescriptions = map[string]metricDescription{
	...
	"complexity_avg": {
		...
		Threshold: defaultExpandThreshold,
...
<li>Create focused interfaces instead of importing full modules</li>
	...
	"circular_deps": {
		...
		Threshold: strictExpandThreshold,
		Detailed: `<h4>Definition</h4>
...
<li>Include contribution guidelines and code conventions</li>
	...
	"comment_density": {
		...
		Threshold: lenientExpandThreshold,
		Detailed: `<h4>Definition</h4>
...
func getMetricDescription(metricName string) metricDescription {
	...
	return metricDescription{Threshold: defaultExpandThreshold}
}
